        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
              ...
              <p className="text-xs font-semibold text-blue-500 uppercase tracking-widest mb-2 flex items-center gap-1.5">
              ...
              <p className="text-sm text-slate-500 mt-1.5 flex items-center gap-2 flex-wrap">
                ...
                {!isLoading_ && requests.length > 0 && (
                  <span className="inline-flex items-center bg-blue-50 text-blue-600 text-xs font-semibold px-2.5 py-0.5 rounded-full">
            ...
            {isCommunityMember && (
              <button
                ...
                className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-200 shadow-blue-200/60 hover:shadow-blue-300/40 active:scale-95 shrink-0 self-start sm:self-auto"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
            ...
            {isAdmin && (
              <>
                ...
                <select
                  ...
                  className="border border-gray-200 rounded-xl px-3.5 py-1.5 text-xs bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent shadow-sm"
                >
        ...
        <div className="relative mb-6">
          ...
          <input
            ...
            className="w-full border border-gray-200 rounded-2xl pl-11 pr-4 py-3 text-sm bg-white text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent shadow-sm"
          />
        </div>
        ...
        {isLoading_ ? (
          ...
          <div className="text-center py-20">
            ...
            {hasActiveFilters && (
              <button
                onClick={handleClearFilters}
                className="mt-4 text-sm font-semibold text-blue-500 hover:text-blue-600 transition-colors"
              >
                Clear all filters
              </button>
            )}
