        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
              ...
              <p className="text-xs font-semibold text-coral-500 uppercase tracking-widest mb-2 flex items-center gap-1.5">
                <span className="h-1.5 w-1.5 rounded-full bg-coral-500 inline-block animate-pulse" />
                Live Feed
              </p>
              ...
              <p className="text-sm text-slate-500 mt-1.5 flex items-center gap-2 flex-wrap">
                ...
                {!isLoading_ && requests.length > 0 && (
                  <span className="inline-flex items-center bg-coral-50 text-coral-600 text-xs font-semibold px-2.5 py-0.5 rounded-full">
            ...
            {isCommunityMember && (
              <button
                ...
                className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-coral-500 to-coral-600 hover:from-coral-600 hover:to-coral-700 text-white px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-200 shadow-coral hover:shadow-coral-lg active:scale-95 shrink-0 self-start sm:self-auto"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
              ...
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full text-xs font-semibold transition-all duration-150 ${
                  typeFilter === t
                    ...
                    : "bg-white text-slate-600 border border-gray-200 hover:border-coral-200 hover:text-coral-600 hover:bg-coral-50/60 shadow-sm"
                }`}
              >
            ...
            {isAdmin && (
              <>
                ...
                <select
                  ...
                  className="border border-gray-200 rounded-xl px-3.5 py-1.5 text-xs bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-coral-400 focus:border-transparent shadow-sm"
                >
        ...
        <div className="relative mb-6">
          ...
          <input
            ...
            className="w-full border border-gray-200 rounded-2xl pl-11 pr-4 py-3 text-sm bg-white text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-coral-400 focus:border-transparent shadow-sm"
          />
        </div>
        ...
        {isLoading_ ? (
          ...
          <div className="text-center py-20">
            ...
            {hasActiveFilters && (
              <button
                onClick={handleClearFilters}
                className="mt-4 text-sm font-semibold text-coral-500 hover:text-coral-600 transition-colors"
              >
                Clear all filters
              </button>
            )}
